  ...
  : Cname_(Cname)
{
  ...
  G4double SegsizeX = sT0_SegsizeX;
  G4double SegsizeY = sT0_SegsizeY;
  G4double SegsizeZ = sT0_SegsizeZ;
  ...
  for( G4int id=1; id<=sT0_SegNum; ++id ){
    G4double ofsScinX=-sT0_SegSpacing*(sT0_SegNum/2.+0.5-id);
