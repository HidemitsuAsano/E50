...
struct Event{
  ...
  double d_pbeam, d_ubeam, d_vbeam, d_abmom;
  double d_prim1, d_prip1;
  double d_pritheta1, d_priphi1, d_prithetacm1, d_priphicm1;
  double d_prim2, d_prip2;
  double d_pritheta2, d_priphi2, d_prithetacm2, d_priphicm2;
...
int main(Int_t argc, char **argv)
{
  ...
  for( int i=0; i<n_entries; i++ ){
    ...
    ana.prithetacm1 = event.d_prithetacm1, ana.prithetacm2 = event.d_prithetacm2; 
    ana.priphicm1 = event.d_priphicm1, ana.priphicm2 = event.d_priphicm2; 
...
void SetBranchAddress( TChain *chain )
{
  ...
  chain->SetBranchAddress("abmom", &event.d_abmom); 
  ...
  chain->SetBranchAddress("prithetacm1", &event.d_prithetacm1); 
  chain->SetBranchAddress("prithetacm2", &event.d_prithetacm2); 
  chain->SetBranchAddress("priphicm1", &event.d_priphicm1); 
  chain->SetBranchAddress("priphicm2", &event.d_priphicm2); 
...
void InitializeAna( void )
{
  ...
  ana.priphi1 = -9999.0; 
  ana.priphi2 = -9999.0;
  ana.prithetacm1 = -9999.0; 
  ana.prithetacm2 = -9999.0;
  ana.priphicm1 = -9999.0; 
  ana.priphicm2 = -9999.0;
...
{ 
  ...
  tree->Branch("prithetacm1", &ana.prithetacm1); 
  tree->Branch("prithetacm2", &ana.prithetacm2); 
  tree->Branch("priphicm1", &ana.priphicm1); 
  tree->Branch("priphicm2", &ana.priphicm2); 
