  ...
  : Cname_(Cname)
{
  ...
  //Rectangle box
  G4Box *solidBaseA1 =
    new G4Box( Cname_+"BaseA1", BoxsizeX/2., BoxsizeZ/2., BoxsizeY/2. );
  G4Box *solidBaseA2 =
    new G4Box( Cname_+"BaseA2", BoxsizeX/2.-FrameT1, BoxsizeZ/2.-FrameT1, BoxsizeY/2.-FrameT1 );
  G4Box *solidBaseA3 =
    new G4Box( Cname_+"BaseA3", BoxsizeX2/2.-FrameT2, FrameT1/2., BoxsizeY2/2.-FrameT2 );
  ...
  G4SubtractionSolid *solidBaseA =
    new G4SubtractionSolid( Cname_+"BaseA", solidBaseA4, solidBaseA3,
			    0, G4ThreeVector( 0.0*mm, (BoxsizeZ-FrameT1)/2., 0.0*mm) );
  ...
  //Radiator box
  G4Trd *solidBaseB1 =
    new G4Trd( Cname_+"BaseB1", BoxsizeX2/2., BoxsizeX1/2., 
  	       BoxsizeY2/2., BoxsizeY1/2., BoxsizeZ1/2.);
  G4Trd *solidBaseB2 =
    new G4Trd( Cname_+"BaseB2", BoxsizeX2/2.-FrameT2, BoxsizeX1/2.-FrameT2, 
	       BoxsizeY2/2.-FrameT2, BoxsizeY1/2.-FrameT2, BoxsizeZ1/2.-FrameT2 );
  ...
  RMx.rotateX( -90.*degree );
  
  G4UnionSolid *solidFrame =
    new G4UnionSolid( Cname_+"Frame", solidBaseA, solidBaseB,
  		      G4Transform3D( RMx, G4ThreeVector( 0.0*mm, PosRB, 0.0*mm)) );
  G4UnionSolid *solidGas =
    new G4UnionSolid( Cname_+"Gas", solidGas1, solidGas2,
  		      G4Transform3D( RMx, G4ThreeVector( 0.0*mm, PosGas, 0.0*mm)) );

  G4Box *solidAerogel =
    new G4Box( Cname_+"Aerogel", SegsizeX/2., SegsizeZ/2., SegsizeY/2. );
  ...
  G4VPhysicalVolume *physFrame =
    new G4PVPlacement( 0, G4ThreeVector( 0.0*mm, (-1.)*BoxsizeZ1/2., 0.0*mm ),
  ...
  G4VPhysicalVolume *physAerogel =
    new G4PVPlacement( 0, G4ThreeVector( 0.0*mm, (BoxsizeZ - SegsizeZ)/2.+ BoxsizeZ1, 0.0*mm ),
