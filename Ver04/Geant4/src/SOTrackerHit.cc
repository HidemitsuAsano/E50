...
SOTrackerHit::SOTrackerHit()
  : layerID_(0), segID_(0), time_(-100.0), edep_(0.0),
    trackNo_(0), fSignal_(false)
{}

G4Allocator<SOTrackerHit> SOTrackerHitAllocator;

void SOTrackerHit::Draw() const
{
...
void SOTrackerHit::Print() const
{
  G4cout << "SOTrackerHit " << std::setw(2) << layerID_ << "-" 
