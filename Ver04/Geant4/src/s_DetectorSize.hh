...
//SFT
static const G4double SFT_LaysizeX   =  800.0*mm;
static const G4double SFT_LaysizeY   =  800.0*mm;
static const G4double SFT_LaysizeZ   =    0.75*mm;
static const G4double SFT_TiltAngle  =    0.0*degree;
...
static const G4double AFT_RotAngleR  =  255.0*degree;
static const G4double AFT_RotAngleL  =  105.0*degree;
...
static const G4double IT2_RotAngleR    =  255.0*degree;
static const G4double IT2_RotAngleL    =  105.0*degree;
