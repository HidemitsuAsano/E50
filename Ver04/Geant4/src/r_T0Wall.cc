  ...
  : Cname_(Cname)
{
  ...
  G4Box *solidMPPC =
    new G4Box( Cname_+"MPPC", MPPCsizeX/2., MPPCsizeZ/2., MPPCsizeY/2. );
  G4Box *solidPCB =
    new G4Box( Cname_+"PCB", PCBsizeX/2., PCBsizeZ/2., PCBsizeY/2. );
  ...
  for( int id=1; id<=SegNum; ++id ){
    ...
    new G4PVPlacement( 0, G4ThreeVector( ofsScinX, 0.0*mm, (SegsizeY/2.+MPPCsizeY/2.) ),
		       Cname_+"MPPCu", logMPPC, physBox, false, 0 );
    new G4PVPlacement( 0, G4ThreeVector( ofsScinX, 0.0*mm, (-1.)*(SegsizeY/2.+MPPCsizeY/2.) ),
		       Cname_+"MPPCd", logMPPC, physBox, false, 0 );
  }
  {
    new G4PVPlacement( 0, G4ThreeVector( 0.0*mm, 0.0*mm, (SegsizeY/2.+MPPCsizeY/2.+PCBsizeY/2.) ),
		       Cname_+"PCBu", logPCB, physBox, false, 0 );
    new G4PVPlacement( 0, G4ThreeVector( 0.0*mm, 0.0*mm, (-1.)*(SegsizeY/2.+MPPCsizeY/2.+PCBsizeY/2.) ),
