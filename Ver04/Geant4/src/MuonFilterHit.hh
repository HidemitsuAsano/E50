...
#ifndef MuonFilterHit_h
#define MuonFilterHit_h 1
...
class MuonFilterHit : public G4VHit
{
public:
  MuonFilterHit();
  ~MuonFilterHit() { }
private:
  MuonFilterHit( const MuonFilterHit & );
  MuonFilterHit & operator = ( const MuonFilterHit & );
public:
  int operator == ( const MuonFilterHit & ) const { return 0; }
...
typedef G4THitsCollection<MuonFilterHit> MuonFilterHitsCollection;
extern G4Allocator<MuonFilterHit> MuonFilterHitAllocator;

inline void * MuonFilterHit::operator new( size_t )
{
  return static_cast<void *>( MuonFilterHitAllocator.MallocSingle() );
}

inline void MuonFilterHit::operator delete( void *aHit )
{
  MuonFilterHitAllocator.
    FreeSingle( static_cast<MuonFilterHit *>( aHit ) );
}
