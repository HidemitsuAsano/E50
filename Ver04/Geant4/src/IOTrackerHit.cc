...
IOTrackerHit::IOTrackerHit()
  : layerID_(0), segID_(0), time_(-100.0), edep_(0.0),
    trackNo_(0), fSignal_(false)
{}

G4Allocator<IOTrackerHit> IOTrackerHitAllocator;

void IOTrackerHit::Draw() const
{
...
void IOTrackerHit::Print() const
{
  G4cout << "IOTrackerHit " << std::setw(2) << layerID_ << "-" 
