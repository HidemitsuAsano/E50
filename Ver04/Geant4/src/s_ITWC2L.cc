...
s_ITWC2L::s_ITWC2L( const G4String & Cname,
...
void s_ITWC2L::SetVisAttributes( const G4VisAttributes *attLayer,
...
void s_ITWC2L::SetSensitiveDetector( G4VSensitiveDetector *SD )
{
