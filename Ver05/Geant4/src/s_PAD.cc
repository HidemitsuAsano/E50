  ...
  : Cname_(Cname)
{
  ...
  //PAD Box
  G4Box *solidBoxA =
    new G4Box( Cname_+"BoxA", BoxsizeX/2., BoxsizeY_A/2., BoxsizeZ/2. );
  G4Box *solidBoxB =
    new G4Box( Cname_+"BoxB", BoxsizeX/2., BoxsizeY_B/2., BoxsizeZ/2. );
  G4Box *solidBoxC =
    new G4Box( Cname_+"BoxC", BoxsizeX/2., BoxsizeY_C/2., BoxsizeZ/2. );
  G4Box *solidBoxD =
    new G4Box( Cname_+"BoxD", BoxsizeX2/2., BoxsizeY_D/2., BoxsizeZ/2. );
  G4Box *solidBoxE =
    new G4Box( Cname_+"BoxE", BoxsizeX2/2., BoxsizeY_E/2., BoxsizeZ/2. );

  G4UnionSolid *solidBox1 =
    new G4UnionSolid( Cname_+"Box1", solidBoxA, solidBoxA,
  		      0, G4ThreeVector( BoxsizeX*(PAD_SegNum/2.+0.5-5.0), -OffsetA, 0.0*mm ) );
  G4UnionSolid *solidBox2 =
    new G4UnionSolid( Cname_+"Box2", solidBox1, solidBoxA,
  		      0, G4ThreeVector( BoxsizeX*(PAD_SegNum/2.+0.5-7.0), -OffsetA, 0.0*mm ) );
  G4UnionSolid *solidBox3 =
    new G4UnionSolid( Cname_+"Box3", solidBox2, solidBoxB,
  		      0, G4ThreeVector( BoxsizeX*(PAD_SegNum/2.+0.5-4.0), -OffsetB, 0.0*mm ) );
  G4UnionSolid *solidBox4 =
    new G4UnionSolid( Cname_+"Box4", solidBox3, solidBoxB,
  		      0, G4ThreeVector( BoxsizeX*(PAD_SegNum/2.+0.5-8.0), -OffsetB, 0.0*mm ) );
  G4UnionSolid *solidBox5 =
    new G4UnionSolid( Cname_+"Box5", solidBox4, solidBoxC,
  		      0, G4ThreeVector( BoxsizeX*(PAD_SegNum/2.+0.5-3.0), -OffsetC, 0.0*mm ) );
  G4UnionSolid *solidBox6 =
    new G4UnionSolid( Cname_+"Box6", solidBox5, solidBoxC,
  		      0, G4ThreeVector( BoxsizeX*(PAD_SegNum/2.+0.5-9.0), -OffsetC, 0.0*mm ) );
  G4UnionSolid *solidBox7 =
    new G4UnionSolid( Cname_+"Box7", solidBox6, solidBoxD,
  		      0, G4ThreeVector( BoxsizeX*(PAD_SegNum/2.+0.5-2.0)-BoxsizeX2/2., -OffsetD, 0.0*mm ) );
  G4UnionSolid *solidBox8 =
    new G4UnionSolid( Cname_+"Box8", solidBox7, solidBoxD,
  		      0, G4ThreeVector( BoxsizeX*(PAD_SegNum/2.+0.5-10.0)+BoxsizeX2/2., -OffsetD, 0.0*mm ) );
  G4UnionSolid *solidBox9 =
    new G4UnionSolid( Cname_+"Box9", solidBox8, solidBoxE,
  		      0, G4ThreeVector( BoxsizeX*(PAD_SegNum/2.+0.5-1.0)-1.5*BoxsizeX2, -OffsetE, 0.0*mm ) );
  G4UnionSolid *solidBox10 =
    new G4UnionSolid( Cname_+"Box10", solidBox9, solidBoxE,
  		      0, G4ThreeVector( BoxsizeX*(PAD_SegNum/2.+0.5-11.0)+1.5*BoxsizeX2, -OffsetE, 0.0*mm ) );

  
  //PAD seg
  G4Box *solidSegA =
    new G4Box( Cname_+"SegmentA", SegsizeX/2., SegsizeY_A/2., SegsizeZ/2. );
  G4Box *solidSegB =
    new G4Box( Cname_+"SegmentB", SegsizeX/2., SegsizeY_B/2., SegsizeZ/2. );
  G4Box *solidSegC =
    new G4Box( Cname_+"SegmentC", SegsizeX/2., SegsizeY_C/2., SegsizeZ/2. );
  G4Box *solidSegD =
    new G4Box( Cname_+"SegmentD", SegsizeX2/2., SegsizeY_D/2., SegsizeZ/2. );
  G4Box *solidSegE =
    new G4Box( Cname_+"SegmentE", SegsizeX2/2., SegsizeY_E/2., SegsizeZ/2. );

  G4UnionSolid *solidSeg1 =
    new G4UnionSolid( Cname_+"Seg1", solidSegA, solidSegA,
  		      0, G4ThreeVector( SegsizeX*(PAD_SegNum/2.+0.5-5.0), -OffsetA, 0.0*mm ) );
  G4UnionSolid *solidSeg2 =
    new G4UnionSolid( Cname_+"Seg2", solidSeg1, solidSegA,
  		      0, G4ThreeVector( SegsizeX*(PAD_SegNum/2.+0.5-7.0), -OffsetA, 0.0*mm ) );
  G4UnionSolid *solidSeg3 =
    new G4UnionSolid( Cname_+"Seg3", solidSeg2, solidSegB,
  		      0, G4ThreeVector( SegsizeX*(PAD_SegNum/2.+0.5-4.0), -OffsetB, 0.0*mm ) );
  G4UnionSolid *solidSeg4 =
    new G4UnionSolid( Cname_+"Seg4", solidSeg3, solidSegB,
  		      0, G4ThreeVector( SegsizeX*(PAD_SegNum/2.+0.5-8.0), -OffsetB, 0.0*mm ) );
  G4UnionSolid *solidSeg5 =
    new G4UnionSolid( Cname_+"Seg5", solidSeg4, solidSegC,
  		      0, G4ThreeVector( SegsizeX*(PAD_SegNum/2.+0.5-3.0), -OffsetC, 0.0*mm ) );
  G4UnionSolid *solidSeg6 =
    new G4UnionSolid( Cname_+"Seg6", solidSeg5, solidSegC,
  		      0, G4ThreeVector( SegsizeX*(PAD_SegNum/2.+0.5-9.0), -OffsetC, 0.0*mm ) );
  G4UnionSolid *solidSeg7 =
    new G4UnionSolid( Cname_+"Seg7", solidSeg6, solidSegD,
  		      0, G4ThreeVector( SegsizeX*(PAD_SegNum/2.+0.5-2.0)-SegsizeX2/2., -OffsetD, 0.0*mm ) );
  G4UnionSolid *solidSeg8 =
    new G4UnionSolid( Cname_+"Seg8", solidSeg7, solidSegD,
  		      0, G4ThreeVector( SegsizeX*(PAD_SegNum/2.+0.5-10.0)+SegsizeX2/2., -OffsetD, 0.0*mm ) );
  G4UnionSolid *solidSeg9 =
    new G4UnionSolid( Cname_+"Seg9", solidSeg8, solidSegE,
  		      0, G4ThreeVector( SegsizeX*(PAD_SegNum/2.+0.5-1.0)-1.5*SegsizeX2, -OffsetE, 0.0*mm ) );
  G4UnionSolid *solidSeg10 =
    new G4UnionSolid( Cname_+"Seg10", solidSeg9, solidSegE,
  		      0, G4ThreeVector( SegsizeX*(PAD_SegNum/2.+0.5-11.0)+1.5*SegsizeX2, -OffsetE, 0.0*mm ) );
