...
MakeSpecMagnet( G4VPhysicalVolume *pMother, G4Material *matGap )
{
  ...
  //Box
  G4Box* solid= new G4Box("FMM", 1500.*cm/2., 1500.*cm/2., 1500.*cm/2.); 
  ...
  G4LogicalVolume* LVYokeTB_U= new G4LogicalVolume( solidYokeTB, mMag_, nmYoke );
  G4LogicalVolume* LVYokeTB_D= new G4LogicalVolume( solidYokeTB, mMag_, nmYoke );
  ...
  new G4PVPlacement
    (zeRot, G4ThreeVector( -3.35*cm,  203.5*cm, 0.*cm), LVYokeTB_U, nmYoke, DetLV_, false, Id_);
  new G4PVPlacement
    (zeRot, G4ThreeVector( -3.35*cm, -203.5*cm, 0.*cm), LVYokeTB_D, nmYoke, DetLV_, false, Id_);

  new G4PVPlacement( zeRot, G4ThreeVector( -237.20*cm, 0.*cm, 0.*cm), LVYokeR, nmYoke, DetLV_, false, Id_);
  ...
  G4LogicalVolume* LVPole0_U= new G4LogicalVolume( solidPole0, mMag_, nmPole );
  G4LogicalVolume* LVPole0_D= new G4LogicalVolume( solidPole0, mMag_, nmPole );

  G4LogicalVolume* LVPole1_U= new G4LogicalVolume( solidPole1, mMag_, nmPole );
  G4LogicalVolume* LVPole1_D= new G4LogicalVolume( solidPole1, mMag_, nmPole );

  G4RotationMatrix *rot4 = new G4RotationMatrix();
  rot4-> rotateX(-90.0*degree);
  new G4PVPlacement( rot4, G4ThreeVector( 0.*cm,  142.*cm, 0.*cm), LVPole0_U, nmPole, DetLV_, false, Id_);
  new G4PVPlacement( rot4, G4ThreeVector( 0.*cm, -142.*cm, 0.*cm), LVPole0_D, nmPole, DetLV_, false, Id_);
  new G4PVPlacement( rot4, G4ThreeVector( 0.*cm,  86.0*cm, 0.*cm), LVPole1_U, nmPole, DetLV_, false, Id_);
  new G4PVPlacement( rot4, G4ThreeVector( 0.*cm, -86.0*cm, 0.*cm), LVPole1_D, nmPole, DetLV_, false, Id_);

  //Coil
  G4Tubs *solidCoil = new G4Tubs( nmCoil, 106.*cm, 129.5*cm, 30./2.*cm, 0., 2.*3.14 );
  G4LogicalVolume* LVCoil_U= new G4LogicalVolume( solidCoil, mMag_, nmCoil );
  G4LogicalVolume* LVCoil_D= new G4LogicalVolume( solidCoil, mMag_, nmCoil );

  G4RotationMatrix *rot5 = new G4RotationMatrix();
  rot5-> rotateX(90.0*degree);
  new G4PVPlacement( rot5, G4ThreeVector( 0.*cm, 147.*cm, 0.*cm), LVCoil_U, nmCoil, DetLV_, false, Id_);
  new G4PVPlacement( rot5, G4ThreeVector( 0.*cm,-147.*cm, 0.*cm), LVCoil_D, nmCoil, DetLV_, false, Id_);

  //Visualization
  G4VisAttributes *va1 = new G4VisAttributes( G4Color( 0.0, 0.5, 1.0 ) ); //Blue
  G4VisAttributes *va2 = new G4VisAttributes( G4Color( 1.0, 0.0, 0.0 ) ); //Red

  if( !confMan->InternalImage() ){
    DetLV_-> SetVisAttributes(G4VisAttributes::GetInvisible());

    LVYokeTB_U-> SetVisAttributes(va1);
    LVYokeTB_D-> SetVisAttributes(va1);
    LVYokeR-> SetVisAttributes(va1);
    LVYokeL-> SetVisAttributes(va1);

    LVPole0_U-> SetVisAttributes(va1);  
    LVPole0_D-> SetVisAttributes(va1);  
    LVPole1_U-> SetVisAttributes(va1);
    LVPole1_D-> SetVisAttributes(va1);

    LVCoil_U-> SetVisAttributes(va2);
    LVCoil_D-> SetVisAttributes(va2);
  }
  else{
    DetLV_-> SetVisAttributes(G4VisAttributes::GetInvisible());

    LVYokeTB_U-> SetVisAttributes(G4VisAttributes::GetInvisible());
    LVYokeTB_D-> SetVisAttributes(va1);
    LVYokeR-> SetVisAttributes(G4VisAttributes::GetInvisible());
    LVYokeL-> SetVisAttributes(va1);

    LVPole0_U-> SetVisAttributes(G4VisAttributes::GetInvisible());  
    LVPole0_D-> SetVisAttributes(va1);  
    LVPole1_U-> SetVisAttributes(G4VisAttributes::GetInvisible());
    LVPole1_D-> SetVisAttributes(va1);

    LVCoil_U-> SetVisAttributes(G4VisAttributes::GetInvisible());
    LVCoil_D-> SetVisAttributes(va2);
  }  

  G4RotationMatrix rotMtx_; 
  rotMtx_.rotateX( 0.*degree );
  rotMtx_.rotateZ( 0.*degree );
  ...
  G4double tgtSizeX=0., tgtSizeY=0., tgtSizeZ=0.; 
  ...
  RMTgt.rotateX( geomMan.GetRotAngle1(lnumTarg)*degree );
  RMTgt.rotateY( geomMan.GetRotAngle2(lnumTarg)*degree );
  
  G4VPhysicalVolume *physTGTBox =
    new G4PVPlacement( G4Transform3D( RMTgt, targPos ),
  ...
  if( !confMan->InternalImage() ){
    ...
    logTGT->SetVisAttributes(TgtAttrib);
    logTGTC->SetVisAttributes(&G4VisAttributes::Invisible);
    logTGTM->SetVisAttributes(&G4VisAttributes::Invisible);
    logTGTB->SetVisAttributes(&G4VisAttributes::Invisible);
  }
  ...
  if( s_DetFlag ){
    ...
    G4RotationMatrix RMT0;
    RMT0.rotateY( geomMan.GetRotAngle2(idt0)*degree );
    
    s_T0Wall *s_T0 =
      new s_T0Wall( "T0", DetLV_, RMT0, gPosT0, OfsLT0, 
    		    mList_->Scin, 
		    mList_->Air );
    ...
    G4RotationMatrix RMBFTU;
    RMBFTU.rotateY( geomMan.GetRotAngle2(id101)*degree );

    s_BFTU *s_BT1 =
      new s_BFTU( "BT1", DetLV_, RMBFTU, 
    ...
    G4RotationMatrix RMBFTD;
    RMBFTD.rotateY( geomMan.GetRotAngle2(id107)*degree );
    
    s_BFTD *s_BT2 =
      new s_BFTD( "BT2", DetLV_, RMBFTD, 
    ...
    G4RotationMatrix RMSFT;
    RMSFT.rotateY( geomMan.GetRotAngle2(id1)*degree );
    
    s_SFT *s_SF1 =
      new s_SFT( "SF1", DetLV_, RMSFT, 
    		 gPos1,  gPos2,  gPos3, 
    		 gPos4,  gPos5,  gPos6,
    		 gPos7,  gPos8,  gPos9, 
    ...
    ///////////////////// AFTR(x,x)
    G4int id31=geomMan.GetDetectorId("AFTR-x-1");
    G4int id32=geomMan.GetDetectorId("AFTR-x-2");
    ...
    RMAFTR.rotateY( geomMan.GetRotAngle2(id31)*degree );
    ...
    ///////////////////// AFTL(x,x)
    G4int id33=geomMan.GetDetectorId("AFTL-x-1");
    G4int id34=geomMan.GetDetectorId("AFTL-x-2");
    ...
    RMAFTL.rotateY( geomMan.GetRotAngle2(id33)*degree );
    ...
    G4RotationMatrix RMIT1;
    RMIT1.rotateY( geomMan.GetRotAngle2(id15)*degree );
    
    s_ITWC1 *s_IT1 =
      new s_ITWC1( "IT1", DetLV_, RMIT1, 
    ...
    G4int id41 =geomMan.GetDetectorId("IT2R-x-1");
    G4int id42 =geomMan.GetDetectorId("IT2R-v-1");
    G4int id43 =geomMan.GetDetectorId("IT2R-u-1");
    G4int id44 =geomMan.GetDetectorId("IT2R-v-2");
    G4int id45 =geomMan.GetDetectorId("IT2R-u-2");
    G4int id46 =geomMan.GetDetectorId("IT2R-x-2");
    G4int id47 =geomMan.GetDetectorId("IT2R-v-3");
    G4int id48 =geomMan.GetDetectorId("IT2R-u-3");
    G4int id49 =geomMan.GetDetectorId("IT2R-x-3");
    ...
    RMIT2R.rotateY( geomMan.GetRotAngle2(id41)*degree );
    ...
    G4int id51 =geomMan.GetDetectorId("IT2L-x-1");
    G4int id52 =geomMan.GetDetectorId("IT2L-u-1");
    G4int id53 =geomMan.GetDetectorId("IT2L-v-1");
    G4int id54 =geomMan.GetDetectorId("IT2L-u-2");
    G4int id55 =geomMan.GetDetectorId("IT2L-v-2");
    G4int id56 =geomMan.GetDetectorId("IT2L-x-2");
    G4int id57 =geomMan.GetDetectorId("IT2L-u-3");
    G4int id58 =geomMan.GetDetectorId("IT2L-v-3");
    G4int id59 =geomMan.GetDetectorId("IT2L-x-3");
    ...
    RMIT2L.rotateY( geomMan.GetRotAngle2(id51)*degree );

    s_ITWC2L *s_IT2L =
      new s_ITWC2L( "IT2L", DetLV_, RMIT2L, 
    		    gPos51, gPos52, gPos53, 
    		    gPos54, gPos55, gPos56, 
    		    gPos57, gPos58, gPos59,
    		    OfsLIT2L, 
    		    id51, id52, id53, 
    		    id54, id55, id56, 
    		    id57, id58, id59, 
    ...
    G4RotationMatrix RMST1;
    RMST1.rotateY( geomMan.GetRotAngle2(id61)*degree );
    
    s_STWC1 *s_ST1 =
      new s_STWC1( "ST1", DetLV_, RMST1, 
    ...
    G4RotationMatrix RMST2;
    RMST2.rotateY( geomMan.GetRotAngle2(id71)*degree );

    s_STWC2 *s_ST2 =
      new s_STWC2( "ST2", DetLV_, RMST2, 
    ...
    RMTOF.rotateY( geomMan.GetRotAngle2(idtof)*degree );

    s_TofWall *s_Tof =
      new s_TofWall( "TOF", DetLV_, RMTOF, gPosTof, OfsLTof, 
    		     mList_->Scin, 
    		     mList_->Air );
    ...
    RMITOFR.rotateY( geomMan.GetRotAngle2(iditofr)*degree );
    ...
    RMITOFL.rotateY( geomMan.GetRotAngle2(iditofl)*degree );
    ...
    RMITOFSR.rotateY( geomMan.GetRotAngle2(iditofsr)*degree );
    ...
    RMITOFSL.rotateY( geomMan.GetRotAngle2(iditofsl)*degree );
    ...
    if( !confMan->InternalImage() ){    
      ...
      s_ITofR->SetVisAttributes( ITofScinAttrib, &G4VisAttributes::Invisible );
      s_ITofL->SetVisAttributes( ITofScinAttrib, &G4VisAttributes::Invisible );
      s_ITofSR->SetVisAttributes( &G4VisAttributes::Invisible, 
				  &G4VisAttributes::Invisible );
      s_ITofSL->SetVisAttributes( ITofScinAttrib, &G4VisAttributes::Invisible );
    }
    ...
    RMPADU.rotateX( geomMan.GetRotAngle1(idpadu)*degree );
    ...
    RMPADD.rotateX(  geomMan.GetRotAngle1(idpadd)*degree );
    ...
    if( !confMan->InternalImage() ){    
      ...
      s_PADU->SetVisAttributes( &G4VisAttributes::Invisible, 
				&G4VisAttributes::Invisible );
      s_PADD->SetVisAttributes( PADScinAttrib, &G4VisAttributes::Invisible );
    }
    ...
    G4RotationMatrix RMRICH;  
    RMRICH.rotateY( geomMan.GetRotAngle2(idrich)*degree );

    s_RICH *s_Rich =
      new s_RICH( "RICH", DetLV_, RMRICH, gPosRICH, OfsLRICH, 
    		  mList_->Aerogel, 
    ...
    RMPID1R.rotateY( geomMan.GetRotAngle2(idpid1r)*degree );
    ...
    RMPID1L.rotateY( geomMan.GetRotAngle2(idpid1l)*degree*degree );
    ...
    RMPID2R.rotateY( geomMan.GetRotAngle2(idpid2r)*degree );
    ...
    RMPID2L.rotateY( geomMan.GetRotAngle2(idpid2l)*degree );
    ...
    RMMF.rotateY( geomMan.GetRotAngle2(idmfu)*degree );
  ...
  if( r_DetFlag ){
    ...
    r_T0Wall *r_T0 =
      new r_T0Wall( "T0", DetLV_, RMT0, gPosT0, OfsLT0, 
  ...
  G4Box *solidVD1 = 
    new G4Box( "VD1", 300.*mm/2., 200.*mm/2., 1.0*mm/2. );
  ...
  G4RotationMatrix RMVD1;  
  RMVD1.rotateY( geomMan.GetRotAngle2(idvd1)*degree );
  ...
  G4Box *solidVD2 = 
    new G4Box( "VD2", 2000.*mm/2., 950.*mm/2., 1.*mm/2. );
  ...
  G4RotationMatrix RMVD2;  
  RMVD2.rotateY( geomMan.GetRotAngle2(idvd2)*degree );
  ...
  G4Box *solidVD3 = 
    new G4Box( "VD3", 5000.*mm/2., 4000.*mm/2., 1.*mm/2. );
  ...
  G4RotationMatrix RMVD3;  
  RMVD3.rotateY( geomMan.GetRotAngle2(idvd3)*degree );

  G4VPhysicalVolume *physVD3 =
    new G4PVPlacement( G4Transform3D( RMVD3,
