...
MuonFilterHit::MuonFilterHit()
  : layerID_(0), segID_(0), time_(-100.0), edep_(0.0),
    trackNo_(0), fSignal_(false)
{}

G4Allocator<MuonFilterHit> MuonFilterHitAllocator;

void MuonFilterHit::Draw() const
{
...
void MuonFilterHit::Print() const
{
  G4cout << "MuonFilterHit " << std::setw(2) << layerID_ << "-" 
