...
BTrackerHit::BTrackerHit()
  : layerID_(0), segID_(0), time_(-100.0), edep_(0.0),
    trackNo_(0), fSignal_(false)
{}

G4Allocator<BTrackerHit> BTrackerHitAllocator;

void BTrackerHit::Draw() const
{
...
void BTrackerHit::Print() const
{
  G4cout << "BTrackerHit " << std::setw(2) << layerID_ << "-" 
