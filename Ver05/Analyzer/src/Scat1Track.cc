...
bool Scat1Track::saveTrackParameters( const RKScat1CordParameter &cp )
{
  ...
  //hPntCont object of RKScat1HitPointContainer
  //RKScat1HitPointContainer: implemented in RungeKuttaUtilitiesScat1.hh
  //class inherited from vector of pair of RKScat1calcHitPoint
  //RKScat1calcHitPoint: class defined in RungeKuttaUtilitiesScat1.hh   
  //, which contains 3 vector of pos and mom. S(?),L(?) and many derivatives 
