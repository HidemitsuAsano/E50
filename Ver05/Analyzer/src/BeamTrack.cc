...
bool BeamTrack::doFit( void )
{
  ...
  ThreeVector globalPosAtVirtualTarget = TrGeomMan::GetInstance().
    Local2GlobalPos( IdVTg, ThreeVector( xVTg, yVTg, 0.0 ) );
  double pz = iniP_/sqrt(1.+uVTg*uVTg+vVTg*vVTg);
  ThreeVector globalMomAtVirtualTarget = TrGeomMan::GetInstance().
...
#if 0
  {
    ...
    std::cout << funcname << ": X (" 
	      << std::setw(9) << globalPosVirtualTarget.x() << ","
	      << std::setw(9) << globalPosVirtualTarget.y() << ","
	      << std::setw(9) << globalPosVirtualTarget.z() << ")";
    std::cout.precision(5);
    std::cout << " P "
	      << std::setw(9) << globalMomAtVirtualTarget.mag() << " (" 
	      << std::setw(9) << globalMomAtVirtualTarget.x() << ","
	      << std::setw(9) << globalMomAtVirtualTarget.y() << ","
	      << std::setw(9) << globalMomAtVirtualTarget.z() << ")"
	      << std::endl;
  ...
  RKBeamCordParameter iniCord( globalPosAtVirtualTarget, globalMomAtVirtualTarget );
