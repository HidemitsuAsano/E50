...
private:
  ...
  std::string name_;
  ThreeVector pos_;
  double tiltAngle_, rotAngle1_, rotAngle2_;//Euler angle
  double length_;
  double resol_;
  double w0_, dd_, ofs_;

  //matrix elements for rotation by Euler angle
  //see TrGeomRecord::calcVectors(void) for actual implementation
