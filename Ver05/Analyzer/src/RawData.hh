...
private:
  ...
  TrRHitContainer BSFTRHC[PlMaxBSFT+1];
  TrRHitContainer SSFTRHC[PlMaxSSFT+1];
...
public:
  ...
  const TrRHitContainer & GetBSFTRHC( int layer ) const;
  const TrRHitContainer & GetSSFTRHC( int layer ) const;
